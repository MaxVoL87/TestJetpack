package com.example.testjetpack.utils.paging
...
class PagingRequestHelper (private val mRetryService: Executor) {
    ...
    internal class RequestWrapper(val mRequest: Request, val mHelper: PagingRequestHelper, val mType: RequestType) :
        Runnable {
